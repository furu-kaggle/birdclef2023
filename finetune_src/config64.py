...
class CFG:
    ...
    #pretrain model path
    eval_pretrainpath = "data/8d85b719dc7575510502df59c942eb78b6b7146b/model_0.858_eval.bin"
    all_pretrainpath = "data/8d85b719dc7575510502df59c942eb78b6b7146b/model_all_last.bin"
